...
HD_PWD='F:/11_github/tank_war/p_vga.runs/blk_mem_gen_03_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_03.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_03.tcl

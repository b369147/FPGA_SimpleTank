...
HD_PWD='F:/10_Vivado/tank_war/FPGA_TankWar/FPGA_TankWar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TankWar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TankWar.tcl

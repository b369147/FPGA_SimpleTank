...
HD_PWD='F:/10_Vivado/tank_war/FPGA_TankWar/FPGA_TankWar.runs/blk_mem_gen_01_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_01.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_01.tcl

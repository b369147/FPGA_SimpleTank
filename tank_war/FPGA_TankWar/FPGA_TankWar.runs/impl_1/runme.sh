...
HD_PWD='F:/10_Vivado/tank_war/FPGA_TankWar/FPGA_TankWar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TankWar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TankWar.tcl -notrace

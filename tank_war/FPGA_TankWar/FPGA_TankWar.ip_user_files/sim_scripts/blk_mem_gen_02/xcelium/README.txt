...
#
# Generated by export_simulation on Mon Jun 06 16:18:27 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_02.sh' script.

./blk_mem_gen_02.sh -reset_run
...
./blk_mem_gen_02.sh -noclean_files

For more information on the script, please type './blk_mem_gen_02.sh -help'.
